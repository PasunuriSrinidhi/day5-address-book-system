...
public class EditContactAddressBook {
    ...
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);
        EditContactAddressBook addressBook = new EditContactAddressBook();

        int choice;
        do {
            System.out.println("\nChoose an option:");
            System.out.println("1. Add Contact\t2. Edit Contact\t3. Display Contacts\t4. Exit");
